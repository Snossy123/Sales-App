...
import type { DashboardInstallmentSummary, DashboardStats, GpsProduct, PaginatedResponse, Branch } from '../api/types'
...
import { computeDashboardInsights } from '../lib/pageStats'
      ...
      <AsyncState isLoading={query.isLoading} isError={query.isError} error={query.error}>
        {query.data && (
          <>
            ...
            <div className="mb-md grid grid-cols-1 gap-md xl:grid-cols-2">
              {last3Months.length > 0 && (
                <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-md">
                  <h3 className="mb-xs text-sm font-bold text-on-surface">آخر 3 أشهر</h3>
                  <p className="mb-sm text-xs text-on-surface-variant">مبيعات · تعاقدات · تحصيل</p>
